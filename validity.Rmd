...
First, this is an overall view of the number of data entries that need vadility check. There are in total **84** data points need validity check, which account for **7.6%** of coded data, excluding the correction data. They are distributed quite evenly over years, similar to those data that do not need validity check. This indicates that most companies continue operating until now.
