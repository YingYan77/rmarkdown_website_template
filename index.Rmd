...
- Up to 11 September, **71.6%** (141 out of 197) of those companies have been either coded or checked as ceased. 
- **10.2%** (i.e. 20) of companies have been taken by a coder but its corresponding data haven't been updated in the tosco2_updating file. 
- This left 36 companies (**18.3%**) waited to be code. 
...
agg_progress %>%
  ...
  hc_subtitle(
    text = "This pie chart shows 71.6% of total ISP comapnies has been coded, and 
    56 companies still need to be coded later on."
  ) %>%
