...
- Up to 15 November, **92.9%** (184 out of 198) of those companies have been either coded or checked as ceased. 
- **5.6%** (i.e. 11) of companies have been taken by a coder but its corresponding data haven't been updated in the tosco2_updating file. 
- This left 3 companies (**1.5%**) waited to be code. 
...
agg_progress %>%
  ...
  hc_subtitle(
    text = "This pie chart shows 92.4% of total ISP comapnies has been coded, and 
    15 companies still need to be coded later on."
  ) %>%
